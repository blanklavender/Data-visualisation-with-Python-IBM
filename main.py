...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
          ...
          x='Vehicle_Type',
          y='Automobile_Sales',
          title="Average Automobile Sales fluctuation by Vehicle Type"
        ))
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots                 
    elif (selected_year!='Select Year' and selected_statistics=='Yearly Statistics') : 
...
# Plot bar chart for average number of vehicles sold during the given year
        avgv_sold = yearly_data.groupby('Vehicle_Type')['Automobile_Sales'].mean().reset_index()
        Y_chart3 = dcc.Graph(
            figure=px.bar(avgv_sold,
                x='Vehicle_Type',
                y='Automobile_Sales',
